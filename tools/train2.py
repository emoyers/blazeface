...
from config import cfg_mnet, cfg_slim, cfg_rfb, cfg_blaze, cfg_blaze1
...
parser.add_argument('--network', default='Blaze1', help='Backbone network mobile0.25 or slim or RFB')
...
def train():
    ...
    for iteration in range(start_iter, max_iter):
        ...
        # forward
        out = net(images)
        # print("output net:", out[0].shape, out[1].shape, out[2].shape)
